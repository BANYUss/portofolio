  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          Information Technology student focused on building modern software
          solutions. Experienced in developing web applications, mobile apps, and
          AI-integrated systems through personal projects and freelance work.
        </p>
      ...
      >
        <div style={{ position: "relative", width: 270, padding: 12 }}>
          {/* Photo — no border, bigger */}
          <div
            style={{
              width: 270,
              height: 320,
              borderRadius: 20,
              overflow: "hidden",
              boxShadow: "0 16px 48px rgba(0,0,0,0.5), 0 0 32px rgba(99,102,241,0.06)",
              background: "var(--surface)",
              position: "relative",
            }}
          >
          ...
          >
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#f05340", flexShrink: 0 }} />
            Laravel
          </div>
        </div>
